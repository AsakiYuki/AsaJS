...
description: "Learn how to define and structure elements using AsaJS."
contributors:
    - AsakiYuki
---
...
[Modify Elements](/jsonui/modify-elements): Learn how to modify and extend Minecraft UI using AsaJS.
