...
**AsaJS** is a [open-source](https://github.com/AsakiYuki/asajs) framework designed to simplify the process of building JsonUI interfaces for **Minecraft: Bedrock Edition.**
...
-   [AsaJS](/api-referencei):
    API reference of AsaJS
...
Ready to build?
Start with [Getting Started](/jsonui/getting-started) to create your first AsaJS project.
