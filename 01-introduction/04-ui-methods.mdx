...
-   Params:
    -   properties: [Properties](/jsonui/properties)
...
-   Params:
    -   element?: string | [UI](/jsonui/ui), properties?: [Properties](/jsonui/properties), name?: string, callback?: (args: [UI](/jsonui/ui), name: string) => void,
...
-   Params
    -   bindings: [BindingInterface](/jsonui/binding-interface) | [BindingInterface](/jsonui/binding-interface)[]
